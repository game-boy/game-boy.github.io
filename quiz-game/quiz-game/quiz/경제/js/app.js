...
function result(){
  ...
  var txt = '<h1>결과</h1>' + '<h2 id = "score"> 당신의 점수: '+ quiz.score + '개를 맞췄습니다.</h2>' + '<a href="../../../../i_wanna_carrot/ranking.html?quiz_IT"><button class="btn2"> IT 퀴즈 랭킹보기 </button></a>';
  quiz_div.innerHTML = txt;


    writeUserData(quiz_IT,quiz.score);


    writeUserData(quiz_IT,uid,name,photo,quiz.score);
}
